...
<small>Preview</small></h1>
	<ol class="breadcrumb">
		...
		<li class="active">Copy article</li>
	</ol>
</section>
					<?php 
			...
			<div class="box box-info">
				...
				<div class="box-body">
						<div class="form-group" >
							...
							<?php
								echo $this->Form->input('title',array('type'=>'text','class'=>'form-control','id'=>'title','value'=>$article_info['Tbl_article']['title']));
							?>
						</div>
						<div class="form-group" >
							...
							<?php //print_r($parent_id);
								...
								echo $this->Form->input('catid',array('options'=>$arrayCategories,'empty'=>'--Main--','value'=>$article_info['Tbl_article']['catid'],'class'=>'form-control'));
							?>
						</div>
						<div class="form-group" style="width:20%;">
							<label>Status</label> 
							<?php 
								echo $this->Form->input('state',array('type'=>'select','options'=>array(1=>'Hiển thị',0=>'Ẩn'),'empty'=>'--Select--','selected'=>$article_info['Tbl_article']['state'],'class'=>'form-control'))
							?>
						</div>	
						...
						<div class="form-group" >
							<label>Summary</label>
							<?php
								echo $this->Form->textarea('summary',array('class'=>'form-control','id'=>'summary','value'=>$article_info['Tbl_article']['summary'],'rows'=>3,'cols'=>80));
							?>
						</div>
						<div class="form-group" >
							<label>Content</label>
							<?php
								echo $this->Form->textarea('content',array('class'=>'form-control ckeditor','id'=>'editor1','value'=>$article_info['Tbl_article']['content'],'rows'=>10,'cols'=>80));
							?>
						</div>
				</div>
			...
			<div class="box box-info">
                ...
                <div class="box-body">
					...
					<div class="form-group">
						...
						<?php
							echo $this->Form->input('created_by_alias',array('type'=>'text','class'=>'form-control','id'=>'created_by_alias','value'=>$article_info['Tbl_article']['created_by_alias']));
						?>
					</div>
					<div class="form-group">
						<label>Created Date</label>
						<?php
							echo $this->Form->input('created_at',array('type'=>'text','class'=>'form-control datetimepicker','id'=>'created_at','value'=>$article_info['Tbl_article']['created_at']));
						?>
					</div>
					<!-- <div class="form-group">
