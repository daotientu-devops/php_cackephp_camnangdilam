			...
			<div class="box box-info">
				...
				<div class="box-body">
						<div class="form-group" >
							...
							<?php
								echo $this->Form->input('category_name',array('type'=>'text','class'=>'form-control','id'=>'category_name','value'=>$category_info['Tbl_category']['category_name'],'disabled'=>true));
							?>
						</div>
						<div class="form-group" >
							...
							<?php //print_r($parent_id);
								...
								echo $this->Form->input('parent_id',array('options'=>$arrayCategories,'empty'=>'--Main--','value'=>$category_info['Tbl_category']['parent_id'],'class'=>'form-control','disabled'=>true));
							?>
						</div>
						<div class="form-group" style="width:20%;">
							<label>Trạng thái</label> 
							<?php 
								echo $this->Form->input('published',array('type'=>'select','options'=>array(1=>'Hiển thị',0=>'Ẩn'),'empty'=>'--Select--','selected'=>$category_info['Tbl_category']['published'],'class'=>'form-control','disabled'=>true))
							?>
						</div>	
						...
						<div class="form-group" >
							<label>Mô tả</label>
							<?php
								echo $this->Form->textarea('description',array('class'=>'form-control','id'=>'description','value'=>$category_info['Tbl_category']['description'],'rows'=>3,'disabled'=>true));
							?>
						</div>
				</div>
			</div>
			...
			<div class="box box-info">
                ...
                <div class="box-body">
					...
					<div class="form-group" style="width:50%;">
						...
						<?php
							echo $this->Form->input('updated_by',array('type'=>'text','class'=>'form-control','id'=>'updated_by','value'=>$category_info['Tbl_category']['updated_by'],'disabled'=>true));
						?>
					</div>
					<div class="form-group" style="width:50%;">
						<label>Updated Date</label>
						<?php
							echo $this->Form->input('updated_at',array('type'=>'text','class'=>'form-control','id'=>'updated_at','value'=>$category_info['Tbl_category']['updated_at'],'disabled'=>true));
						?>
					</div>
                </div>
            </div>
